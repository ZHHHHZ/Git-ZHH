...
def get_dv(start = 20170101,end = 20180101): 
    ...
    #define
    factor_list  = ['alpha33','alpha58','alpha114','alpha173','LongDebtToWorkingCapital','OperCashGrowRate','Kurtosis120','Beta252']
...
from Tamplate import alpha33,alpha58,alpha114,alpha173,LongDebtToWorkingCapital,OperCashGrowRate,Kurtosis120,Beta252

for f in ['alpha33','alpha58','alpha114','alpha173','LongDebtToWorkingCapital','OperCashGrowRate','Kurtosis120','Beta252']:
