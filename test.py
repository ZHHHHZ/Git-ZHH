...
def get_dv(start = 20170101,end = 20180101): 
    ...
    #define
    factor_list  = ['alpha01a','alpha02a','alpha03a','alpha04a','alpha05a','alpha06a','alpha07a','alpha08a','alpha09a','alpha10a']
...
from Tamplate import alpha01a,alpha02a,alpha03a,alpha04a,alpha05a,alpha06a,alpha07a,alpha08a,alpha09a,alpha10a

for f in ['alpha01a','alpha02a','alpha03a','alpha04a','alpha05a','alpha06a','alpha07a','alpha08a','alpha09a','alpha10a']:
